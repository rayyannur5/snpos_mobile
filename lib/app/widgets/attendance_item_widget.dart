...
class AttendanceItemWidget extends GetView {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Get.toNamed(Routes.DETAIL_ABSENSI, arguments: {'id': id}),
      child: Container(
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  Text('Keluar : ${dateOut == null ? '-' :  DateFormat('dd/MM/yyyy HH:mm').format(dateOut!)}', style: Get.textTheme.labelSmall)
                ],
              ),
            ),
            Expanded(
